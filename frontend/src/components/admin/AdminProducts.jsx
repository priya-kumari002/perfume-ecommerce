    ...
    <div>
        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="flex gap-2 mt-3">
              <button
                onClick={() => openModal(product)}
                className="flex-1 py-2 bg-blue-600 rounded-lg text-sm"
              >
                Edit
              </button>
              <button
                onClick={() => handleDelete(product._id)}
                className="flex-1 py-2 bg-red-600 rounded-lg text-sm"
              >
                Delete
              </button>
            </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto p-4 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-black border border-gray-700 rounded-lg outline-none"
                />
                {imageFiles.length > 0 && (
